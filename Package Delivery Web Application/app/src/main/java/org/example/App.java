...
public class App {
    ...
    private void init() throws IOException {
        ...
        WorldUps.UCommands.Builder worldSpeed =  WorldUps.UCommands.newBuilder().setSimspeed(10000000);
        sendRequset(worldSpeed.build(), world_connect.getWorld_socket().getOutputStream());

        amazon_connect = new AmazonConnect(12316, world_connect.getWorldid(), world_connect);
